...
public class DiscountCalculator {
     ...
     *
     * <p><b>Zero-floor guarantee.</b> The running subtotal is floored at {@code 0.00} after
     * every coupon, so the returned total is <b>never negative</b>, even when the coupons would
     * otherwise discount more than the price.</p>
     *
     * <p><b>Null / empty handling.</b> A {@code null} {@code price} is treated as {@code 0.00};
     * a {@code null} or empty {@code coupons} list returns {@code price} unchanged (the
     ...
     *                empty list returns {@code price} unchanged (the no-coupon baseline), and any
     *                {@code null} or malformed coupon in the list is skipped
